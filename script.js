...
const translations = {
    en: {
        ...
        about_description: "Empowering Hope Project was born from Byamugish Hillary’s desire to help the community in a completely selfless way. A project that began in early 2026 with the hope of bringing light and electricity to people living in the most remote areas of Uganda.",
    ...
    es: {
        ...
        about_description: "Empowering Hope Project nace del deseo de Byamugish Hillary de ayudar a su comunidad de forma totalmente desinteresada. Un proyecto que arrancó a comienzos de 2026 con la ilusión de poder dar luz y electricidad a las personas de las zonas más remotas de Uganda.",
        ...
        help_text: "Cada contribución instala otro panel solar — otra noche de deberes, otra noche segura, otro futuro iluminado.",
    ...
    de: {
        ...
        about_description: "Empowering Hope Project entstand aus dem Wunsch von Byamugish Hillary, seiner Gemeinschaft auf völlig selbstlose Weise zu helfen. Ein Projekt, das Anfang 2026 mit der Hoffnung startete, Licht und Elektrizität in die abgelegensten Regionen Ugandas zu bringen.",
    ...
    fr: {
        ...
        about_description: "Empowering Hope Project est né du désir de Byamugish Hillary d’aider sa communauté de manière totalement désintéressée. Un projet qui a vu le jour au début de l’année 2026 avec l’espoir d’apporter la lumière et l’électricité aux populations des régions les plus reculées de l’Ouganda.",
